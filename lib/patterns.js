...
// ==================== BUNDLER PATTERNS ====================
export const BUNDLER_PATTERNS = [
  // Webpack version detection
  {
    pattern: /webpack[\/\\@](\d+\.\d+\.\d+[^"'\s]*)/gi,
    type: "Webpack"
  },
  {
    pattern: /["']webpack["'].*?["'](\d+\.\d+\.\d+[^"'\s]*)['"]/gi,
  ...
  // webpack runtime detection
  {
    pattern: /webpackJsonp|__webpack_require__|__webpack_modules__|webpack:\s*(\d+\.\d+\.\d+)/gi,
    type: "Webpack"
  },

  // Vite version detection
  {
    pattern: /vite[\/\\@](\d+\.\d+\.\d+[^"'\s]*)/gi,
    type: "Vite"
  },
  {
    pattern: /__vite__/gi,
  ...
  {
    pattern: /rollup[\/\\@](\d+\.\d+\.\d+[^"'\s]*)/gi,
    type: "Rollup"
  },
  {
    pattern: /\/\*\*\* Rollup \((\d+\.\d+\.\d+[^)]*)\)/gi,
    type: "Rollup"
  },

  // Parcel version detection
  {
    pattern: /parcel-bundler[\/\\@](\d+\.\d+\.\d+[^"'\s]*)/gi,
    type: "Parcel"
  },
  {
    pattern: /parcel[\/\\@](\d+\.\d+\.\d+[^"'\s]*)/gi,
    type: "Parcel"
  },
  {
    pattern: /__parcel__/gi,
    type: "Parcel"
  },

  // esbuild version detection
  {
    pattern: /esbuild[\/\\@](\d+\.\d+\.\d+[^"'\s]*)/gi,
    type: "esbuild"
  },
  {
    pattern: /\/\* esbuild (\d+\.\d+\.\d+[^*]*)/gi,
    type: "esbuild"
  },

  // Browserify version detection
  {
    pattern: /browserify[\/\\@](\d+\.\d+\.\d+[^"'\s]*)/gi,
    type: "Browserify"
  },

  // Turbopack version detection
  {
    pattern: /turbopack[\/\\@](\d+\.\d+\.\d+[^"'\s]*)/gi,
    type: "Turbopack"
  },

  // SWC version detection
  {
    pattern: /@swc\/core[\/\\@](\d+\.\d+\.\d+[^"'\s]*)/gi,
    type: "SWC"
  },

  // Metro bundler (React Native)
  {
    pattern: /metro[\/\\@](\d+\.\d+\.\d+[^"'\s]*)/gi,
    type: "Metro"
  },

  // FuseBox version detection
  {
    pattern: /fuse-box[\/\\@](\d+\.\d+\.\d+[^"'\s]*)/gi,
    type: "FuseBox"
  },

  // Snowpack version detection
  {
    pattern: /snowpack[\/\\@](\d+\.\d+\.\d+[^"'\s]*)/gi,
    type: "Snowpack"
  },

  // WMR version detection
  {
    pattern: /wmr[\/\\@](\d+\.\d+\.\d+[^"'\s]*)/gi,
    type: "WMR"
  },
];
